...
const Login = () => {
  ...
  const { user, isLoading, error, authenticate } = useSelector((state) => state.user);
  ...
  useEffect(() => {
    ...
    if (error) {
      alert(error.message || 'Login mein koi masla ho gaya');
    }
  }, [authenticate, error, navigate]);

  const handleSubmit = (e) => {
    e.preventDefault();
    if (!email || !password) {
      return alert('Please email aur password daalein');
    }
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center dark:bg-red-900">
      <div className="grid gap-8">
          ...
          <div className="border-[20px] border-transparent rounded-[20px] dark:bg-gray-900 bg-white shadow-lg xl:p-10 2xl:p-10 lg:p-10 md:p-10 sm:p-2 m-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                className="bg-gradient-to-r dark:text-gray-300 from-blue-500 to-purple-500 shadow-lg mt-6 p-2 text-white rounded-lg w-full hover:scale-105 hover:from-purple-500 hover:to-blue-500 transition duration-300 ease-in-out disabled:opacity-50"
                type="submit"
                disabled={isLoading} // Jab loading ho rahi ho to button disable kar do
              >
            ...
            <div className="flex flex-col mt-4 items-center justify-center text-sm">
              <h3 className="dark:text-gray-300">
                ...
                {/* React Router ka Link use karein */}
...
///////// extra login ka page with customizations///////
...
//               LOG IN
//             </button> */}
//             <button className=" dark:text-gray-300   shadow-lg mt-6 p-2 text-black rounded-lg w-full hover:scale-105  transition duration-300 ease-in-out" type="submit">
//               LOG IN
//             </button>
//           </form>
//           <div className="flex flex-col mt-4 items-center justify-center text-sm">
